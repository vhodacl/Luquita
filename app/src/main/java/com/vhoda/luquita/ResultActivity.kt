...
class ResultActivity : AppCompatActivity() {
    ...
    private val bankLogos = mapOf(
        ...
        "BCI/MACH" to R.drawable.mach,
        "BICE" to R.drawable.bancobice,
        "Banco de Chile" to R.drawable.bancochile,
        "Banco de Chile-Edwards-Credichile" to R.drawable.edwards,
        ...
        "Banco Ripley/CHEK" to R.drawable.bancoripley,
        "Banco Santander" to R.drawable.santander,
        "Banco Security" to R.drawable.bancosecurity,
        "Banco Consorcio" to R.drawable.consorcio,
        "Coopeuch/DALE" to R.drawable.coopeuch,
        "Copec PAY" to R.drawable.copec,
        "CORP-BANCA" to R.drawable.bancocorpbanca,
        "Global66" to R.drawable.global66,
        "Banco Itaú" to R.drawable.itau,
        "Lapolar Prepago" to R.drawable.lapolar,
        "Mercado Pago" to R.drawable.mercadopago,
        "Scotiabank" to R.drawable.scotiabank,
        "PREX" to R.drawable.prex,
        "TAPP Caja los Andes" to R.drawable.tapp,
        "Prepago Tenpo" to R.drawable.tenpo
    )
